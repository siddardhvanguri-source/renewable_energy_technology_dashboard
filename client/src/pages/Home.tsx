...
export default function Home() {
  ...
  return <div className="instrument-page"><FlowField density="sparse" /><div className="ambient-orbit orbit-one" /><div className="ambient-orbit orbit-two" />
    ...
    <div className="notice-bar"><Terminal size={13} /><span>{notice}</span><span className="notice-spacer" /><span className="micro-label">{connection === "DEMO / MOCK" ? "DEMO" : "LIVE"}</span><span className="status-dot" /></div>
